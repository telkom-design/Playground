...
import 'deepmerge';
import { useThemeUI, jsx } from '@theme-ui/core';
export { ThemeProvider } from '@theme-ui/core';
import { get } from '@theme-ui/css';
import { Button as Button$1, Input, Link, Container, Switch as Switch$1, Textarea as Textarea$1, Radio as Radio$1, Badge as Badge$1, Avatar as Avatar$1, Heading as Heading$1, Text, Spinner as Spinner$1, Alert as Alert$1, Flex, Box, Close } from '@theme-ui/components';
export { Divider, AspectImage as Image } from '@theme-ui/components';
...
var Button = function Button(_ref) {
  ...
  var sizes = get(context.theme, "buttons." + size);
  var variants = get(context.theme, "buttons." + variant);
  return jsx(Button$1, Object.assign({
    sx: _extends({}, variants, sizes)
  }, rest, {
    disabled: disabled
  }), iconLeft && size === 'lg' && jsx("span", {
    className: 'wrapper-icon-left-large'
  }, iconLeft) || iconLeft && size === 'md' && jsx("span", {
    className: 'wrapper-icon-left-medium'
  }, iconLeft) || iconLeft && size === 'sm' && jsx("span", {
    className: 'wrapper-icon-left-small'
  }, iconLeft), children && jsx("span", {
  ...
  }, children), !children && iconLeft && iconRight && size && jsx("span", {
    className: "wrapper-two-icon"
  }), iconRight && size === 'lg' && jsx("span", {
    className: 'wrapper-icon-right-large'
  }, iconRight) || iconRight && size === 'md' && jsx("span", {
    className: 'wrapper-icon-right-medium'
  }, iconRight) || iconRight && size === 'sm' && jsx("span", {
...
var Textfield = function Textfield(_ref) {
  ...
  var context = useThemeUI();
  var variants = get(context.theme, "forms.input." + variant);
  var container = get(context.theme, "forms.input.container");
  var containPrefLeft = get(context.theme, "forms.input.containPrefLeft");
  var wrapperPrefLeft = get(context.theme, "forms.input.wrapperPrefLeft");
  var limitPrefLeft = get(context.theme, "forms.input.limitPrefLeft");
  var wrappPrefLeftIconLeft = get(context.theme, "forms.input.wrappPrefLeftIconLeft");
  var wrappIconLeft = get(context.theme, "forms.input.wrappIconLeft");
  var wrappField = get(context.theme, "forms.input.wrappField");
  var wrappNormal = get(context.theme, "forms.input.wrappNormal");
  var wrappSuccess = get(context.theme, "forms.input.wrappSuccess");
  var wrappError = get(context.theme, "forms.input.wrappError");
  var wrappPrefRightIconRight = get(context.theme, "forms.input.wrappPrefRightIconRight");
  var wrappIconRight = get(context.theme, "forms.input.wrappIconRight");
  var containPrefRight = get(context.theme, "forms.input.containPrefRight");
  var limitPrefRight = get(context.theme, "forms.input.limitPrefRight");
  var wrapperPrefRight = get(context.theme, "forms.input.wrapperPrefRight");
  var wrappLabelField = get(context.theme, "forms.input.wrappLabelField");
  var wrapErrorMessage = get(context.theme, "forms.input.wrapErrorMessage");
  ...
  })), prefixLeft && iconLeft && jsx("span", {
    sx: _extends({}, wrappPrefLeftIconLeft)
  }, iconLeft) || iconLeft && jsx("span", {
    sx: _extends({}, wrappIconLeft)
  }, iconLeft), jsx(Input, Object.assign({}, rest, {
    type: type,
    sx: _extends({}, variants),
    disabled: disabled
  })), variant && disabled && jsx("div", {
    sx: _extends({}, wrappField)
  }) || variant === 'normal' && jsx("div", {
    sx: _extends({}, wrappNormal)
  }) || variant === 'success' && jsx("div", {
    sx: _extends({}, wrappSuccess)
  }) || variant === 'error' && jsx("div", {
    sx: _extends({}, wrappError)
  }), prefixRight && iconRight && jsx("span", {
    sx: _extends({}, wrappPrefRightIconRight)
  }, iconRight) || iconRight && jsx("span", {
    sx: _extends({}, wrappIconRight)
  }, iconRight), prefixRight && jsx("div", {
...
var Checkbox = function Checkbox(_ref) {
  ...
  var context = useThemeUI();
  var labels = get(context.theme, "forms.checkbox." + label);
  var variants = get(context.theme, "forms.checkbox." + variant);
  var sizes = get(context.theme, "forms.checkbox." + variant + "." + sizeBox);
  var sizeBoxLarge = get(context.theme, "forms.checkbox.sizeBoxLarge");
  var sizeBoxSmall = get(context.theme, "forms.checkbox.sizeBoxSmall");
  var wrappLabel = get(context.theme, "forms.checkbox.wrappLabel");
  return jsx(React.Fragment, null, label ? jsx("label", {
    sx: sizeBox === 'lg' ? _extends({}, sizeBoxLarge) : _extends({}, sizeBoxSmall)
  }, jsx(Input, Object.assign({}, rest, {
    type: "checkbox",
    sx: _extends({}, labels, variants, sizes),
    disabled: disabled
  })), jsx("div", {
    sx: _extends({}, wrappLabel)
  }, label)) : jsx(Input, Object.assign({}, rest, {
    type: "checkbox",
    sx: _extends({}, labels, variants, sizes),
    disabled: disabled
  })));
...
var Anchor = function Anchor(_ref) {
  ...
  var context = useThemeUI();
  var sizes = get(context.theme, "styles.a." + size);
  return jsx(React.Fragment, null, jsx(Link, Object.assign({}, rest, {
    sx: _extends({}, sizes, {
    ...
    className: 'wrapper-icon-left-small'
  }, iconLeft), children, iconRight && size === 'lg' && jsx("span", {
    className: 'wrapper-icon-right-large'
  }, iconRight) || iconRight && size === 'md' && jsx("span", {
    className: 'wrapper-icon-right-medium'
  }, iconRight) || iconRight && size === 'sm' && jsx("span", {
...
var LoginPage = function LoginPage(_ref) {
  ...
  return jsx(Container, Object.assign({}, rest), jsx("div", {
  ...
  }, titleLoginPage), jsx("div", {
    className: 'wrapper-desc'
  }, descLoginPage), jsx("form", {
    ...
    iconLeft: jsx(Lock, null),
    label: "Password",
    iconRight: showPass ? jsx(Eye, {
  ...
  }, "Forgot Password")), jsx(Button, {
    className: 'wrapper-button',
    disabled: disabledForm,
    iconLeft: jsx(LogIn, null),
    onClick: function onClick() {
      return onSubmit();
    },
    type: 'submit',
  ...
  }, "Sign in with Google"), jsx("br", null), jsx(Button, {
    size: 'md',
    className: 'wrapper-button',
    variant: 'outlineSecondary'
  }, "Sign in with Facebook"), jsx("div", {
    className: 'wrapper-register'
  }, "Don't have an account?\xA0 ", jsx(Anchor, {
    disabledAncor: disabledForm
  }, "Register Now")), jsx("div", {
    className: 'wrapper-footer'
  }, "\xA9 Legion Design System by Telkom Indonesia")), jsx("div", {
...
var Switch = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var context = useThemeUI();
  var sizes = get(context.theme, "forms.switch." + sizeSwitch);
  return jsx(Switch$1, Object.assign({}, rest, {
    ref: ref,
    sx: _extends({}, sizes)
  }));
});
...
var Textarea = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var context = useThemeUI();
  var labels = get(context.theme, "forms.textarea.labelTextArea");
  var variants = get(context.theme, "forms.textarea." + variant);
  return jsx(React.Fragment, null, jsx("div", {
    sx: _extends({}, labels)
  }, label), jsx(Textarea$1, Object.assign({}, rest, {
    ref: ref,
    sx: _extends({}, variants)
  })));
});
...
var Radio = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  }, jsx(Radio$1, Object.assign({}, rest, {
    ref: ref,
    sx: {
      'input:checked ~ &': {
        // border: '2px solid #E42313',
...
var Badge = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var context = useThemeUI();
  var variants = get(context.theme, "badges." + variant);
  var borders = get(context.theme, "badges." + (bordered ? size + "WithBorder" : size + "NoBorder"));
  var sizes = get(context.theme, "badges." + (rest.children ? size + "WithContent" : size));
  return jsx(Badge$1, Object.assign({
    ref: ref,
...
var Avatar = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  return jsx(Avatar$1, Object.assign({
    ref: ref,
...
var Heading = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var context = useThemeUI();
  var sizes = get(context.theme, "text.heading." + size);
...
var Body = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var context = useThemeUI();
  var variants = get(context.theme, "text.default." + variant);
  return jsx(Text, Object.assign({}, rest, {
    ref: ref,
    sx: _extends({}, variants)
  }), children);
});
var Caption = /*#__PURE__*/React.forwardRef(function (_ref2, ref) {
  ...
  var context = useThemeUI();
  var sizes = get(context.theme, "text.default.sizes." + size);
  return jsx(Text, Object.assign({}, rest, {
    ref: ref,
    sx: _extends({}, sizes)
  }), children);
...
var Spinner = function Spinner(_ref) {
  ...
  var context = useThemeUI();
  var variants = get(context.theme, "spinner." + variant);
  return jsx(React.Fragment, null, size === 'sm' && jsx(Spinner$1, Object.assign({
    sx: _extends({}, variants),
    strokeWidth: 4,
    size: 24
  }, rest)), size === 'md' && jsx(Spinner$1, Object.assign({
    sx: _extends({}, variants)
  }, rest)), size === 'lg' && jsx(Spinner$1, Object.assign({
    sx: _extends({}, variants),
    strokeWidth: 6,
    size: 72
  }, rest)));
...
var Alert = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var context = useThemeUI();
  var variants = get(context.theme, "alerts." + variant);
  return jsx(Alert$1, Object.assign({
    ref: ref,
    sx: _extends({}, variants)
  }, rest), jsx(Flex, {
    sx: {
  ...
  }, children)) : jsx(Text, null, children), jsx(Close, {
    sx: {
      cursor: 'pointer'
    },
...
export { Alert, Anchor, Avatar, Badge, Body, Button, Caption, Checkbox, Heading, LoginPage, Radio, Spinner, Switch, Textarea, Textfield, radius, spacer, text, theme };
//# sourceMappingURL=legion-ui.esm.js.map
